...
- A note has as many pages as you need. The title bar shows **Page x of y**. Turn the page as in the reader: swipe left (or press the forward page button) to go to the next page; on the last page this adds a blank one. Swipe right (or press the back page button) to go back. **Delete page** in the menu removes the current page (after confirmation if it has strokes); blank pages are also dropped when the note is closed
